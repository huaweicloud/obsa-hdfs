...
/**
 * Simple serializer for the {@link FlinkOBSFsRecoverable}.
 */
@Internal
class FlinkOBSRecoverableSerializer implements SimpleVersionedSerializer<FlinkOBSFsRecoverable> {
    ...
    private static FlinkOBSFsRecoverable deserializeV1(byte[] serialized) throws IOException {
        ...
        return new FlinkOBSFsRecoverable(new Path(targetPath), new Path(tempPath), offset);
    }
}
