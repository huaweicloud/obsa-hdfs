 ...
 */
@Deprecated
public class ECSSTSProvider implements STSProvider {

    EcsObsCredentialsProvider credentialsProvider;

    @Override
    public void init(Configuration configuration) {
        credentialsProvider = new EcsObsCredentialsProvider();
    }
    ...
    public GetSTSResponse getSTS(GetSTSRequest request, UserGroupInformation ugi) {
        LimitedTimeSecurityKey sts = (LimitedTimeSecurityKey) credentialsProvider.getSecurityKey();
