 ...
 * @since 2021-05-12
 */
public class SequenceStateTestMap extends RichMapFunction<Tuple2<LongWritable, Text>, Tuple2<LongWritable, Text>> implements CheckpointedFunction {
    ...
    public SequenceStateTestMap(ParameterTool params) {
