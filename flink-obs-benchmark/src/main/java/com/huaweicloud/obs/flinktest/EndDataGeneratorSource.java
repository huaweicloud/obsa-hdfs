...
public class EndDataGeneratorSource extends RichParallelSourceFunction<String>
    implements CheckpointedFunction {

    private static final long serialVersionUID = 1L;

    private static final Logger LOG = LoggerFactory.getLogger(EndDataGeneratorSource.class);

    private final EndSequenceGenerator generator;
     ...
     */
    public EndDataGeneratorSource(
        EndSequenceGenerator generator, long rowsPerSecond, @Nullable Long numberOfRows) {
