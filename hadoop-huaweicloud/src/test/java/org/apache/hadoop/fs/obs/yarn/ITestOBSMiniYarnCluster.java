 ...
 * the License.
 */
package org.apache.hadoop.fs.obs.yarn;
...
import org.apache.hadoop.fs.obs.AbstractOBSTestBase;
...
/**
 * Tests that OBS is usable through a YARN application.
 */
public class ITestOBSMiniYarnCluster extends AbstractOBSTestBase {
  ...
  private void writeStringToFile(Path path, String string) throws IOException {
    FileContext fc = OBSTestUtils.createTestFileContext(conf);
