...
/**
 * OBS tests through the {@link FileContext} API.
 */
public class ITestOBS {
  ...
  public void setUp() throws Exception {
    ...
    fc = OBSTestUtils.createTestFileContext(conf);
  }
  ...
  protected Path getTestPath() {
    return OBSTestUtils.createTestPath(new Path("/tests3afc"));
  }
